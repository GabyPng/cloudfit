...
class ProgresoController extends Controller
{
    ...
    /**
     * Garantiza UTF-8 válido. Datos con acentos/ñ a veces llegan en
     * Windows-1252/Latin-1 y rompen json_encode() ("Malformed UTF-8").
     */
        ...
        $clients = Client::where('clients.coach_id', $coachId)
            ...
            ->map(function ($c) {
                ...
                return [
                    ...
                    'name'     => $name,
                    'initials' => $initials ?: '?',
                    'avatar'   => $this->utf8($c->avatar_url),
                    'objetivo' => $this->utf8($c->objetivo),
                ];
            });
